...
/* harmony import */ var _providers__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../providers */ "./src/providers/index.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _providers__WEBPACK_IMPORTED_MODULE_12__["Api"]
            ],
...
var Api = /** @class */ (function () {
    ...
    Api.prototype.getItem = function () {
        if (this.item) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(this.item);
        }
        else {
            return this.http
                .get('assets/data/item.json')
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(this.getData, this));
        }
    };
...
module.exports = __webpack_require__(/*! /Users/elaine/workspace/ava/src/main.ts */"./src/main.ts");
